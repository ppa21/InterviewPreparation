class Solution {
    /*
        ...
        * space complexity = O(1)
        ...
        matrix = [[1,3,5,7],[10,11,16,20],[23,30,34,60]] -> [1, 3, 5, 7, 10, 11, 16, 20, 23, 30, 34, 60] -> make 2d array into 1d array
    */
    public boolean searchMatrix(int[][] matrix, int target) {
        int rows = matrix.length; // 3
        int cols = matrix[0].length; // 4
        int left = 0;
        int right = (rows * cols) - 1; // index 11; make 2d array into 1d array
